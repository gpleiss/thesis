...
However, we can also view the Cholesky decomposition as an {\bf iterative method}, where each iteration produces a slightly higher rank approximation to the matrix $\bA$.

...
Moreover, the package seamlessly integrates with the PyTorch \cite{paszke2019pytorch}, Pyro \cite{bingham2019pyro}, and BoTorch \cite{balandat2019botorch} packages to combine GPs with neural networks, probablistic models, and blackbox optimizers.

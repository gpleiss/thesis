...
\begin{itemize}
  ...
  \item {\bf \cref{chapter:ciq}} extends the BBMM framework to Gaussian process models with non-Gaussian likelihood functions---i.e. when GPs are used to model heavy-tailed data, arrival processes, or classification problems.

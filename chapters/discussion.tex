...
Advances in large-scale optimization have mostly targeted the piece-wise linear geometry of ReLU neural networks \gp{CITE} and may need to be adapted to the geometry of Gaussian processes.
This is especially true for GP-based models that use alternative objective functions for learning \cite{jankowiak2020parametric} \gp{MORE citations}.
